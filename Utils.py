...
TRANSFER_COMMAND = 5
SEE_TURNOVER = 6
CARD_PAYMENT_COMMAND = 7
INIT_CARD_PAYMENT_COMMAND = 8
EXECUTE_CARD_PAYMENT_COMMAND = 9
PROOF_CARD_PAYMENT_COMMAND = 10
PAYMENT_ORDER_ACK = 11
PAYMENT_EXECUTE_ACK = 12
PAYMENT_EXECUTE_NACK_TRANSFER_CODE = 13
PAYMENT_EXECUTE_NACK_CARDKEY = 14
PAYMENT_EXECUTE_NACK_CARDNUMBER = 15
PAYMENT_PROOF_ACK = 16
PAYMENT_PROOF_NACK = 17
